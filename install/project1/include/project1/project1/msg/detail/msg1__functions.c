...
project1__msg__Msg1__create()
{
  ...
  project1__msg__Msg1 * msg = (project1__msg__Msg1 *)allocator.allocate(sizeof(project1__msg__Msg1), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(project1__msg__Msg1));
  bool success = project1__msg__Msg1__init(msg);
  if (!success) {
...
project1__msg__Msg1__Sequence__init(project1__msg__Msg1__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  project1__msg__Msg1 * data = NULL;

  if (size) {
    data = (project1__msg__Msg1 *)allocator.zero_allocate(size, sizeof(project1__msg__Msg1), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = project1__msg__Msg1__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        project1__msg__Msg1__fini(&data[i - 1]);
      }
...
project1__msg__Msg1__Sequence__fini(project1__msg__Msg1__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      project1__msg__Msg1__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  project1__msg__Msg1__Sequence * array = (project1__msg__Msg1__Sequence *)allocator.allocate(sizeof(project1__msg__Msg1__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = project1__msg__Msg1__Sequence__init(array, size);
  if (!success) {
...
project1__msg__Msg1__Sequence__destroy(project1__msg__Msg1__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    project1__msg__Msg1__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
project1__msg__Msg1__Sequence__are_equal(const project1__msg__Msg1__Sequence * lhs, const project1__msg__Msg1__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!project1__msg__Msg1__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  project1__msg__Msg1__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(project1__msg__Msg1);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    project1__msg__Msg1 * data =
      (project1__msg__Msg1 *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!project1__msg__Msg1__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          project1__msg__Msg1__fini(&output->data[i]);
        }
        return false;
      }
    }
