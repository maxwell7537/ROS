...
#include "my_msgs/msg/detail/msg1__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const my_msgs::msg::Msg1 *>(
    untyped_ros_message);
...
{
  return &my_msgs::msg::typesupport_fastrtps_cpp::_Msg1__handle;
}
