...
#include "my_msgs/msg/detail/send_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_msgs::msg::SendData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_msgs::msg::SendData & ros_message)
{
  // Member: yaw
  cdr >> ros_message.yaw;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_msgs::msg::SendData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_msgs::msg::SendData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_msgs::msg::SendData *>(
    untyped_ros_message);
...
{
  return &my_msgs::msg::typesupport_fastrtps_cpp::_SendData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_msgs, msg, SendData)() {
  return &my_msgs::msg::typesupport_fastrtps_cpp::_SendData__handle;
}
