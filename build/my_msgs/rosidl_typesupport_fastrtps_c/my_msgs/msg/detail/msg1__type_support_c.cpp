...
#include "my_msgs/msg/detail/msg1__rosidl_typesupport_fastrtps_c.h"
...
using _Msg1__ros_msg_type = my_msgs__msg__Msg1;
...
size_t get_serialized_size_my_msgs__msg__Msg1(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Msg1__ros_msg_type * ros_message = static_cast<const _Msg1__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Msg1__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_msgs__msg__Msg1(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_msgs
size_t max_serialized_size_my_msgs__msg__Msg1(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_msgs__msg__Msg1;
    is_plain =
      (
...
static size_t _Msg1__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_msgs__msg__Msg1(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_msgs, msg, Msg1)() {
