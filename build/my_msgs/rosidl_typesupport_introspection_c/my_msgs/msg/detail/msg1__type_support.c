...
#include <stddef.h>
#include "my_msgs/msg/detail/msg1__rosidl_typesupport_introspection_c.h"
...
void my_msgs__msg__Msg1__rosidl_typesupport_introspection_c__Msg1_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  my_msgs__msg__Msg1__init(message_memory);
}

void my_msgs__msg__Msg1__rosidl_typesupport_introspection_c__Msg1_fini_function(void * message_memory)
{
...
static rosidl_typesupport_introspection_c__MessageMember my_msgs__msg__Msg1__rosidl_typesupport_introspection_c__Msg1_message_member_array[3] = {
  {
    ...
    offsetof(my_msgs__msg__Msg1, s),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_msgs__msg__Msg1, num),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers my_msgs__msg__Msg1__rosidl_typesupport_introspection_c__Msg1_message_members = {
  ...
  my_msgs__msg__Msg1__rosidl_typesupport_introspection_c__Msg1_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t my_msgs__msg__Msg1__rosidl_typesupport_introspection_c__Msg1_message_type_support_handle = {
  0,
  &my_msgs__msg__Msg1__rosidl_typesupport_introspection_c__Msg1_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_msgs, msg, Msg1)() {
  ...
  return &my_msgs__msg__Msg1__rosidl_typesupport_introspection_c__Msg1_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
