...
bool my_msgs__msg__send_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_msgs.msg._send_data.SendData", full_classname_dest, 31) == 0);
  }
  my_msgs__msg__SendData * ros_message = _ros_message;
  {  // yaw
...
PyObject * my_msgs__msg__send_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_msgs.msg._send_data");
